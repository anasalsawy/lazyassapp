        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Automate your job search and land interviews faster with AI-powered applications.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Career Tips</a></li>
              <li><a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Resume Guide</a></li>
            </ul>
          </div>
